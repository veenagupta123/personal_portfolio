...
const Projects = () => {
  return (
    ...
    <div className='ML_main_project'>
        ...
        <p className="desc-project-ml">I developed a dynamic and responsive weather forecast website using HTML, CSS, and JavaScript and implemented a user-friendly interface for browsing and searching products with real-time updates.</p>
